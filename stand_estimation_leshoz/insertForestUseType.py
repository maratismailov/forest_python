...
def insert_forest_use_type(forest_use_type, newId, modified, forest_use_type_counter):
    """ delete values from the stand_action table"""
    delete_forest_use_type_query = """DELETE FROM forest.standforestuse WHERE standestimation_id = {} AND plan_fact = 1""".format(newId)
