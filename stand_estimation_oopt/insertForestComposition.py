...
def insert_forest_composition(forest_compose, newId, modified, forest_compose_counter):
    """ delete values from the stand_action table"""
    delete_forest_compose_query = """DELETE FROM forest.forestcomposition WHERE standestimation_id = {}""".format(
        newId)
    ...
    forest_composition = """INSERT INTO forest.forestcomposition (
        ...
        VALUES(%s, %s, %s, %s, %s)"""
    percent = int(forest_compose['species_percent']['code']) * 10
    composition_data = (
